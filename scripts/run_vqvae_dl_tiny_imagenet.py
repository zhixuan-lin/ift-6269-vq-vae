...
from vqvae_lib.api import train_vqvae
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default='./data',
        help='data_dir/tiny_imagenet200 will contain the dataset'
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default='./results',
        help='where to save everything (model/tensorboard/images...)'
    )
    ...
    train_vqvae(
        ...
        exp_name='vqvae_dl_tiny_imagenet',
